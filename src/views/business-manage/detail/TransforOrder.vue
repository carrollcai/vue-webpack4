    ...
    <div class="order-container">
      <el-form :rules="rules"
        ...
        <el-form-item label="预计协议期："
          ...
          <el-form-item prop="predictAgreementTime"
            style="display: inline-block;">
            <el-input v-model="orderData.predictAgreementTime"
              :maxlength="3"
              class="form-input-medium"
              placeholder="请输入预计协议期" />
          </el-form-item>
        ...
        <el-form-item label="项目是否招标："
          ...
          <el-radio v-model="orderData.isProjectInvitation"
            label="1">是</el-radio>
          <el-radio v-model="orderData.isProjectInvitation"
            label="0">否</el-radio>
        </el-form-item>
