    ...
    <div class="m-container visit-create">
      <el-form :label-position="'right'" label-width="140px">
        <el-form-item label="走访主题">
          <el-input class="form-input-medium" placeholder="请输入主题" />
        </el-form-item>
        <el-form-item label="走访公司：">
          <el-input class="form-input-120" placeholder="公司编码">
          </el-input>
          <div class="form-input-sep">-</div>
          <el-input class="form-input-medium" placeholder="公司名称">
          </el-input>
          <div class="form-input-sep">-</div>
          <el-input class="form-input-large" placeholder="走访地址">
          </el-input>
        </el-form-item>
        <el-form-item label="走访对象：" prop="name">
          <el-input maxlength="6" class="form-input-80" placeholder="姓名"></el-input>
          <div class="form-input-sep">-</div>
          ...
          <el-form-item prop="tel" style="display: inline-block;">
            <el-input maxlength="11" class="form-input-120" placeholder="联系电话"></el-input>
          </el-form-item>
        </el-form-item>
        <el-form-item label="我方出席人员：">
          <el-input class="form-input-large" placeholder="可输入多个人员，用“；”隔开" />
        </el-form-item>
        <el-form-item label="走访时间：">
          <el-date-picker class="form-input-medium" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" placeholder="请选择时间"></el-date-picker>
          <div class="form-input-sep">-</div>
        ...
        <el-form-item label="走访内容：">
          <el-input type="textarea" class="form-input-large" placeholder="请输入走访内容" />
        </el-form-item>
        <el-form-item label="涉及商机编码：">
          <el-input class="form-input-medium" placeholder="请输入商机编码" />
        </el-form-item>
        <el-form-item label="问题协调：">
          <el-input type="textarea" class="form-input-large" placeholder="请输入问题协调内容" />
        </el-form-item>
        ...
        <el-form-item label="选择审核人：">
          <el-select class="form-input-medium" placeholder="请选择">
