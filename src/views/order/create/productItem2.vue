<template>
  <div>
    <div class="td"
      v-for="(item, index) in orderCreate.orderProductDtoList"
      :key="index">
      <div>
        <el-form-item :prop="'orderProductDtoList.' + index + '.productName'"
      ...
      <div>
        <el-form-item :prop="'orderProductDtoList.' + index + '.amount'"
      ...
      <div>
        <el-form-item :prop="'orderProductDtoList.' + index + '.processor'"
