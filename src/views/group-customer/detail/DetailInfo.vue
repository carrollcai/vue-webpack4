<template>
  <div class="customer-detail_info">
    <audit-steps v-if="customer.processInsId && processes.length"
      :processList="processes" />
    <div class="block-title base-info_title">
      基本信息
      <span class="base-info_title-sub"
        v-if="customer.visibleRange"
        @click="showMore = !showMore">更多信息</span>
    ...
    <div>
      <el-table border
        ...
        <el-table-column prop="genderValue"
          label="性别">
        </el-table-column>
        ...
        <el-table-column prop="parentContactId"
          label="上级领导">
